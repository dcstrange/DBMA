...
# Step 3. **Generate User's Request Analysis YAML Results**:
    - The User's Request Analysis is preceded and followed by --- separated from the surrounding text
    - Format the Request Analysis in YAML as follows:
    ```
    Request Analysis:
...
# Step 5. **Recourse to the Expert Group**
    ...
    ```
    - In the interaction with Experts Leader Agent, it is necessary to provide the information needed by the expert group, which sometimes requires asking the user. 
