...
class Agency:
    ...
    def _create_expert_tools(self):
        for agent_name in self.agents_and_sessions.keys():
            agent = self.get_agent_by_name(agent_name)
            agent.add_tool(self._create_expert_tool(agent))

    # TODO: 设计专家function，以测试单agent能力
    def _create_expert_data_modeling_tool(self, agent: Agent):
        """
        ...
        class ExpertDataModeling(BaseTool):
            ...
            def run(self, caller_thread):
                ...
                task_description = caller_thread.task_description if caller_thread.task_description else chain_of_thought
                ...
                completion = client.chat.completions.create(
                    ...
                    messages=[
                        ...
                        {"role": "expert", "content": simulator_instruction}
                    ]
                )
                task_response = completion.choices[0].message.content
                return task_response

        return ExpertDataModeling 

    def _create_expert_migration_tool(self, agent: Agent):
        """
        Create expert functions(8 kinds)
        """
    ...
    def _create_expert_monitor_tool(self, agent: Agent):
        """
        Create expert functions(8 kinds)
        """
    ...
    def _create_expert_perf_tuning_tool(self, agent: Agent):
        """
        Create expert functions(8 kinds)
        """
    ...
    def _create_expert_recovery_tool(self, agent: Agent):
        """
        Create expert functions(8 kinds)
        """
    ...
    def _create_expert_scaling_tool(self, agent: Agent):
        """
        Create expert functions(8 kinds)
        """
    ...
    def _create_expert_security_tool(self, agent: Agent):
        """
        Create expert functions(8 kinds)
        """
    ...
    def _create_expert_troubleshooting_tool(self, agent: Agent):
        """
        Create expert functions(8 kinds)
        """
